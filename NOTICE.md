...
Devour is licensed under Apache 2.0. See [`LICENSE`](LICENSE) for the full license text.
...
- **Charles and Ray Eames** ... "The details are not the details. They make the design."
...
- **Christopher Alexander** ... A Pattern Language, The Timeless Way of Building, Notes on the Synthesis of Form

### Layer 2 ... Human-computer interaction

- **Bret Victor** ... Magic Ink (2006), Inventing on Principle (2012), Learnable Programming (2012). [worrydream.com](https://worrydream.com)
...
- **Bruce Tognazzini** ... First Principles of Interaction Design. [asktog.com](https://asktog.com)

### Layer 3 ... Native software craft

- **Imran Chaudhri** and **Bas Ording** ... original iPhone interaction design
- **Loren Brichter** ... Tweetie, pull-to-refresh, considered iOS craft
- **Andy Matuschak** ... working memory, spaced repetition UX, Patches. [andymatuschak.org](https://andymatuschak.org)
- **Andy Allen** ... NotBoring Software. [notboring.software](https://notboring.software)
- **The Linear team** ... linear.app, the Linear Method
- **Jason Yuan** ... MercuryOS, ambient and spatial UI
...
Devour is **not affiliated with, endorsed by, or sponsored by** any of the named individuals, companies, or products. The skill cites and links to public work because that work is the foundation. All trademarks are the property of their respective owners.

If you find your work cited here and would prefer different attribution language, removal, or correction, open an issue at [github.com/plainspace/devour-skills](https://github.com/plainspace/devour-skills/issues) and it will be addressed.

---

## Buy the courses, read the books
...
- Read everything Bret Victor has written
